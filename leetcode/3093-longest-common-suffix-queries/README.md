...
**Problem:** [Longest-Common-Suffix-Queries](https://leetcode.com/problems/longest-common-suffix-queries)
...
Example 1:**Input:** wordsContainer = ["abcd","bcd","xbcd"], wordsQuery = ["cd","bcd","xyz"]
